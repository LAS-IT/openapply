  ...
  context "oa_answer handles code 429 too many request" do
      it "to return a answer after one retry" do
        ...
        stub_request(:get, "#{@oa.api_url}#{@url_kid_95}")
              ...
              .to_return( status: 429, headers: {'X-RateLimit-Period': "1"}, body: '{"error": "Rate limit reached. Retry later."}').then
              .to_return( status: 200, headers: {'X-RateLimit-Period': "1"}, body: SpecData::STUDENT_95_RECORD_HASH.to_json)
