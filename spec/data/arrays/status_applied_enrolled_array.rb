module SpecData
  ...
  STATUS_APPLIED_ENROLLED_ARRAY = [
    ...
    [1, "Terry Robertson", 444, "Hasnah Robertson", 1256, "90.0"],
    [4, "Anne Bennett", 350, "Patricia Bennett", 1257, "90.0"],
    [5, "Nancy Roberts", 412, "Hillary Roberts", 1258, "90.0"],
    [6, "Willie Peterson", 448, "Mette Peterson", 1259, "90.0"],
    [7, "Todd Olson", 414, "Ayesha Olson", 1260, "90.0"]
  ]
